...
namespace MonoScene.Graphics.Pipeline
{
    ...
    public sealed class SolidColorTextureFactory : TextureFactory<XNACOLOR>
    {
        ...
        protected override Texture2D ConvertTexture(XNACOLOR color)
        {
            var data = new XNACOLOR[_Width * _Height];
