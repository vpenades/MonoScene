...
namespace SharpGLTF.Runtime.Content
{
    ...
    sealed class MeshPrimitiveBuilder
    {
        ...
        public void AppendMeshPrimitive(Type vertexType, IMeshPrimitiveDecoder primitive, int logicalMeshIndex, Effect effect, BlendState blending, bool doubleSided)
        {
            ...
            myMethod.Invoke(this, new Object[] { primitive, logicalMeshIndex, effect, blending, doubleSided });
        }

        public void AppendMeshPrimitive<TVertex>(IMeshPrimitiveDecoder primitive, int logicalMeshIndex, Effect effect, BlendState blending, bool doubleSided)
